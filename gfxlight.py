...
Run it alongside any GPU workload (any Python works; torch is not used)::
    ...
    python gfxlight.py --seconds 60

Or from your own process::

    from gfxlight import GfxLight
    light = GfxLight()
    light.start()   # never raises; check is_lit()
    ...             # your GPU work
    light.stop()

This file originates in the *-strix-halo model runners, where an identical copy
ships inside each runner: **fix one and fix the others.**
"""
